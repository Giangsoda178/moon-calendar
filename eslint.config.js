...
export default ts.config(
  ...
  ...svelte.configs.recommended,
  {
    languageOptions: {
      globals: {
        ...globals.browser,
        ...globals.node,
        // Svelte 5 compiler directive for generics (not a runtime variable)
        $$Generic: 'readonly',
      }
    }
  },
  ...
  eslintConfigPrettier,
  {
    rules: {
      ...
      // Security: Warn on {@html} usage to prevent XSS vulnerabilities
      // Use DOMPurify.sanitize() if raw HTML is required
